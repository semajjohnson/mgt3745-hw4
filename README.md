...
![![An entry added to the pool, then the same entry appearing in a second browser that had never loaded the page](docs/demo-hw4.gif)](ScreenRecording2026-09-23at3.24.18AM-ezgif.com-video-to-gif-converter.gif)
